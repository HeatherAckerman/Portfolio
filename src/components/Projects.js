                ...
                <div id="carouselExampleFade" className="carousel slide carousel-fade" data-ride="carousel">
                    <div className="carousel-inner">
                        ...
                        <div className="carousel-item active">
                            ...
                            <p className="pDescription">MERN stack react app designed for the Grandy Community Center.
                            ...
                            <a href={"https://alms4grandy.herokuapp.com/"} target="blank"><button className="btn">See More</button></a><br/><br/>
                        ...
                        <div className="carousel-item">
                            ...
                            <p className="pDescription">Schedule some laughter in your day by using this calendar app that’ll display and save xkcd comics.
                            ...
                            <a href={"https://xkcdaily.herokuapp.com/"} target="blank"><button className="btn">See More</button></a><br/><br/>
                        ...
                        <div className="carousel-item">
                            ...
                            <p className="pDescription">Enjoy the New York Times with a delightful twist that's sure to bring a smile.
                            ...
                            <a href={"https://kyliemegan24.github.io/Consolation_Cat_News_App/"} target="blank"><button className="btn">See More</button></a><br/><br/>
